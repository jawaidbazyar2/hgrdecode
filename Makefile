hgrd: hgrd.cpp ppm.cpp font.cpp util.cpp hgr.cpp hgr.hpp ntsc.cpp Matrix3x3.cpp lgr.cpp dhgr.cpp *.hpp
	clang++ -std=c++17 -O3 -o hgrd hgrd.cpp ppm.cpp font.cpp util.cpp hgr.cpp ntsc.cpp lgr.cpp Matrix3x3.cpp dhgr.cpp
